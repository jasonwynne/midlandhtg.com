				...
				<div class="step2-content hidden" data-step2-additional-cost="0">
					...
					<div class="existing-info-holder hidden">		
						...
						<div class="existing boiler hidden">
							...
							<p class="checkbox-holder"><input id="existing-boiler1" type="radio" name="boiler" value="Gravity" data-added="Extra charge for asbestos abatement: TBD"><label for="existing-boiler1">Gravity Boiler:<br /><img src="<?php bloginfo('template_directory'); ?>/images/ordering/boiler-gravity.jpg" /></label></p>
