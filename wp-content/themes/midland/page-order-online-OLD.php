	...
	<div class="center">
		<div class="content-holder-all">
			...
			<div id="order-info-holder">
				<div class="total">Order Total: <span>$0.00</span></div>
				<div id="my-product" class="product-info-holder">
					<h4>Product:</h4>
					<div class="product-type"></div>	
				</div>
				<div id="my-home" class="product-info-holder ">
					<h4>My Home:</h4>
					<div class="house-info home-questions"></div>	
				</div>
				<div id="my-existing" class="product-info-holder ">
					<h4>My Existing:</h4>
					<div class="existing-info existing"></div>	
				</div>
				<div id="my-selection" class="product-info-holder ">
					<h4>My Selection:</h4>
			...
			<div class="order-holder">
				<div class="step1-content">
					<div class="step-product-holder product-type">	
						...
						<p class="checkbox-holder"><input id="furnace-ac" type="checkbox" name="product" value="Water Heater"><label for="water-heater">Furnace & Air Conditioner</label></p>
						<div class="clear"></div>
					</div>
					<div class="step-product-holder product-brand">	
						<div class="product-brand-holder product-brand0 ">
							<p class="step-instructions">Select what brand you would like to purchase <span></span>:</p>
							<p class="checkbox-holder furnace air-conditioner"><input id="aire-flo-b0" type="radio" name="brand0" value="AIRE-FLO"><label for="aire-flo-b0">AIRE-FLO</label></p>
							<p class="checkbox-holder furnace air-conditioner"><input id="lennox-b0" type="radio" name="brand0" value="LENNOX"><label for="lennox-b0">LENNOX</label></p>
							<p class="checkbox-holder boiler"><input id="slant-fin-b0" type="radio" name="brand0" value="Slant-Fin"><label for="slant-fin-b0">Slant-Fin</label></p>
							<p class="checkbox-holder water-heater"><input id="state-b0" type="radio" name="brand0" value="State"><label for="state-b0">State</label></p>
							<p class="checkbox-holder water-heater"><input id="bradford-white-b0" type="radio" name="brand0" value="Bradford White"><label for="bradford-b0">Bradford White</label></p>
							<p class="checkbox-holder water-heater"><input id="reheem-b0" type="radio" name="brand0" value="Reheem"><label for="reheem-b0">Reheem</label></p>
							<p class="checkbox-holder water-heater"><input id="ao-smith-b0" type="radio" name="brand0" value="A.O. Smith"><label for="ao-smith-b0">A.O. Smith</label></p>
							<div class="clear"></div>
						</div>
					</div>
				...
				<div class="step2-content " data-step2-additional-cost="0">
					...
					<div class="existing-info-holder ">		
						<div class="existing  furnace">
						...
						<div class="existing  furnace-gravity">
						...
						<div class="existing floor-drain  boiler-furnace">
						...
						<div class="existing chimney-liner  boiler-furnace">
						...
						<div class="existing  air-conditioner">
						...
						<div class="existing  water-heater">
				...
				<div class="step3-content ">
					<div id="furnace-recommendations" class="" data-product-type="furnace">
						...
						<?php $custom_query = new WP_Query( array('post_type' => 'products', 'category_name' => 'furnace', 'showposts' => -1 ) );
							...
							<div class=" recommended-product <?php the_field('square_footage'); ?>" data-product-cost="<?php the_field('product_price'); ?>" data-product-id="<?php the_title(); ?>" data-product-brand="<?php the_field('brand');?>" >	
					...
					<div id="air-conditioner-recommendations" class="" data-product-type="air-conditioner">
					...
					<div id="boiler-recommendations" class="" data-product-type="boiler">
					...
					<div id="water-heater-recommendations" class="" data-product-type="water-heater">
						...
						?>
							<div class=" recommended-product <?php echo $myGals ?>" data-product-cost="<?php the_field('product_price'); ?>" data-product-id="<?php the_title(); ?>" data-product-brand="<?php the_field('brand');?>" >	
